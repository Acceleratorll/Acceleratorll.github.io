...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="Home-guest.php" id="user" class="nav-link disabled"><?php echo $_SESSION['username'] ?></a>
                    </li>
                    <li class="nav-item">
                        <a href="Home-guest.php" class="nav-link">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="jumbotron bg-black">
        <center>
            <p class="display-4 text-light"><?php echo $_SESSION['username'] ?></p>
            <p class="h4 text-light">Welcome to BookStore</p>
        </center>
  <hr class="my-4">
</div>
    <center>
