...
session_start();
    ...
    <form action="insert.php" method="get" enctype="multipart/form-data">
        <div class="container-sm p-5 my-5 bg-dark text-white" style="width: 50%;">
                    <legend align="center">Form Insert</legend>
                    <div class="mb-3">
                        <label for="exampleUsername" class="form-label">ID</label>
                        <input type="number" class="form-control form-control-lg" name="id">
                    </div>
                    <div class="mb-3">
                        <label for="exampleUsername" class="form-label">Penerbit</label>
                        <input type="text" class="form-control form-control-lg" name="penerbit">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control form-control-lg" name="harga">
                    </div>
                    <div class="mb-3" align="center">
                        <button type="submit" class="btn btn-success btn-lg" name="insert-btn" id="btn">Insert</button>
                    </div>
            </div>
    </form>
</body>
